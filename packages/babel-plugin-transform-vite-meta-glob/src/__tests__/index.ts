...
pluginTester({
  ...
  tests: {
    ...
    'glob all files eagerly': withFileName('const modules = import.meta.globEager("./fixtures/**/*")'),
    'glob some files eagerly': withFileName('const modules = import.meta.globEager("./fixtures/**/*{1,3}*")'),
    'glob no files eagerly': withFileName('const modules = import.meta.globEager("./fixtures/**/not-found")'),
